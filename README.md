...
- NLP: TF-IDF, Bag of Words, basic Transformers  
...
| [**Terraform Infra Provisioning**](https://github.com/SUHEL782/terraformconcept.com) | Automated AWS VPC, EC2, subnets, routing & security groups |
| [**Monitoring Stack**](https://github.com/SUHEL782/fusionpact-devops-challenge) | Production-ready observability using Prometheus + Grafana with alerting |
...
| [**Text Classification Model – Scikit-learn**](https://github.com/SUHEL782/text-classifier) | NLP model using BoW & TF-IDF with **92% accuracy**, CI/CD enabled |
