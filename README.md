...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0ea5e9&height=150&section=header&text=SUHEL%20KHAN&fontSize=28&fontColor=ffffff"/>
...
**ATS Resume Checker – Production SaaS Platform**  
Resume analysis • Job matching • ATS optimization feedback  

*Built using FastAPI • Docker • Next.js • CI/CD • AWS*
...
- Creating **production-ready SaaS platforms**

I also work with **AI/ML foundations**, focusing on API-based inference systems and MLOps workflows.

> **Automation + Reliability + Scale = Engineering Excellence**
...
- Backend APIs: FastAPI-based ML services  
- MLOps: Dockerized models, CI/CD for deployments  
